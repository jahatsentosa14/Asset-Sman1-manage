...
function SubmitButton() {
  ...
  return (
    <button type="submit" disabled={pending} className="w-full rounded-2xl bg-[#FDBB2D] py-3 text-sm font-bold text-[#1A123B] shadow-[0_10px_25px_rgba(253,187,45,.28)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(26,18,59,.16)] disabled:translate-y-0 disabled:opacity-50">
        ...
        <div className="clay-panel rounded-[2rem] p-7 sm:p-9">
          ...
          <form action={formAction} className="space-y-5">
            <div className="space-y-2">
              <label htmlFor="email" className="text-sm font-semibold text-[#1A123B]">Email</label>
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="text-sm font-semibold text-[#1A123B]">Password</label>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            Belum punya akun? <a href="/register" className="font-bold text-[#1A123B] decoration-[#FDBB2D] decoration-2 underline-offset-4 hover:underline">Daftar sebagai Siswa</a>
          </p>
        </div>
      </div>
    </main>
