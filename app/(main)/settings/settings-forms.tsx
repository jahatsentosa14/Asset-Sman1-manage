    ...
    <StaggerContainer className="space-y-8">
      ...
      <section className="space-y-3 rounded-2xl border border-border bg-background/60 p-5 shadow-sm backdrop-blur">
        ...
        <div className="space-y-1 text-sm">
          ...
          <p className="text-muted-foreground">
            Peran: <span className="text-foreground">{ROLE_LABELS[role] ?? role}</span>
          </p>
        </div>
      </section>
      </StaggerItem>
      ...
      <StaggerItem>
      <section className="space-y-3 rounded-2xl border border-border bg-background/60 p-5 shadow-sm backdrop-blur">
        <h2 className="font-semibold">Edit Nama</h2>
      ...
      <section className="space-y-3 rounded-2xl border border-border bg-background/60 p-5 shadow-sm backdrop-blur">
        ...
        <form action={passwordAction} className="space-y-3">
          ...
          {passwordState.success && (
            <p className="text-sm text-emerald-600">Password berhasil diubah.</p>
          )}
